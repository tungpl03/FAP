            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <nav class="main-nav">
                            <!-- ***** Logo Start ***** -->
                            <a href="Studenthome.jsp" class="logo">
                ...
                <td>
                    <div>
                        <h4 style="font-size: 50px; margin-bottom: 100px">
                            ...
                            <%
                        if (flist.isEmpty()) {%>
                        <p style="font-size: 30px; margin-bottom: 70px"> You haven't studied any subject yet</p>
                        <%
                                }else{
                        %>
                        <p style="font-size: 30px; margin-bottom: 70px">List of feedbacks for <%=flist.get(0).getStudentName()%> (<%=flist.get(0).getStudentId()%>)</p>
                        <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <c:choose>
                                            <c:when test="${item.getPunctuality() == null}">
                                                <td><a href="tofbpage?fbid=${item.getFbid()}">Take feedback</a></td>
                                            </c:when>
                                            <c:otherwise>
                                                <td><a href="tofbpage?fbid=${item.getFbid()}">Retake feedback</a> | <a href="tocommentedit?fbid=${item.getFbid()}">Edit Comment</a></td>                                        
                                            </c:otherwise>
                                        </c:choose>
                                    </tr>
                                </c:forEach>
